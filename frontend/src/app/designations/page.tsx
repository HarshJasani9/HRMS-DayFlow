          ...
          <div className="rounded-lg border border-border bg-card p-5 shadow-soft">
            ...
            <div className="mt-5 overflow-hidden rounded-md border border-border">
              {designations.map((designation) => (
                <div
                  key={designation.id}
                  className="grid gap-3 border-b border-border px-4 py-4 last:border-0 sm:grid-cols-[1fr_auto] sm:items-start"
                >
                  <div>
                    <p className="font-medium text-heading">{designation.title}</p>
