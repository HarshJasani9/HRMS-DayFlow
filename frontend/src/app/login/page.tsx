...
const inputClassName =
  "h-12 w-full rounded-2xl border border-white/80 bg-card px-12 text-sm text-heading shadow-[0_14px_35px_rgba(20,48,39,0.06)] outline-none transition placeholder:text-text-faint focus:border-brand-600 focus:ring-4 focus:ring-brand-100";
  ...
  return (
    ...
    >
      <form className="mt-9" onSubmit={handleSubmit(onSubmit)}>
        {error ? (
          <div className="rounded-md border border-red-200 bg-error-bg px-3 py-2 text-sm text-error-text">
            {error}
          </div>
        ) : null}
        ...
        <div className="mt-4 flex justify-end text-sm">
          <Link className="font-medium text-text-secondary hover:text-brand-700" href="/forgot-password">
            Forgot password?
          </Link>
        </div>
        ...
        <div className="mt-7 flex items-center gap-4 text-xs text-text-muted">
